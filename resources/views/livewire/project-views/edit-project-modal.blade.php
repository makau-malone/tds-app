<div wire:ignore.self class="modal fade" id="editProjectModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    ...
    <div class="form-group row mb-2 mt-3">
        ...
        <div class="col-12">
            <button type="submit" class="btn-app hover-btn">Add Project</button>
        </div>
    </div>
                    </form>
                </div>
